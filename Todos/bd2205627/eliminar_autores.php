...
<body>
    ...
    <?php
    try{
        $sql1="SELECT * FROM autores WHERE Id=".$_REQUEST['cod'].";";
        $resultado = $base->prepare($sql1);
          $resultado->execute(array());
          while ($consulta = $resultado->fetch(PDO::FETCH_ASSOC)) {
              echo "Esta seguro que desea eliminar  autores" .$consulta['nombres_li'];
           }
    }catch(Exeption $e){
    ...
    <tr>
    <td><a href="eliminar_autores2.php?cod2=<?php echo $_REQUEST['cod'] ?>"><img src="img/si.png" 
    width="60px" ></a></td>
